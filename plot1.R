...
#write the png file with the transparent background
png(file="plot1.png", bg="transparent")
with(data_i,hist(Global_active_power,col="red",main="Global Active Power",xlab="Global Active Power (KW)"))
dev.off()
...
print(paste("PNG file succesfully written to ",getwd(),"/plot1.png",sep=""))
