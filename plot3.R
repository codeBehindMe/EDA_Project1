...
png(file="plot3.png",bg="transparent")
      with(data_i,plot(data_i$dateTime,data_i$Sub_metering_1,type="l",col="black",main="Energy Submetering",
                  xlab="Day",ylab="Energy sub metering"))
      with(data_i,points(data_i$dateTime,data_i$Sub_metering_2,type="l",col="red"))
      with(data_i,points(data_i$dateTime,data_i$Sub_metering_3,type="l",col="blue"))
dev.off()
...
print(paste("PNG file succesfully written to ",getwd(),"/plot3.png",sep=""))